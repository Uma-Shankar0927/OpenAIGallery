    ...
    <div className="group-hover:flex flex-col max-h-[94.5%] hidden absolute bottom-0 left-0 right-0 bg-[#FFF] m-2 p-4 rounded-md">
      ...
      <div className="mt-5 flex justify-between items-center gap-2">
        <div className="flex items-center gap-2">
          <div className="w-7 h-7 rounded-full object-cover bg-[#0e0e0e] flex justify-center items-center text-white text-xs font-bold">{name[0]}</div>
          <p className="text-black text-sm">{name.length > 15 ? name.slice(0,15)+'...':name}</p>
        </div>
